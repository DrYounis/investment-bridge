...
const PROGRAMS = [
  {
    ...
    featured: true,
    desc: 'أقوى برامج الأكاديمية — يغطي دورة الإيرادات الطبية كاملة: coding، تدقيق المطالبات، منصة NPHIES، وإدارة الرفض. تخصص عميق بالعربي لا تجده في أي مكان آخر. تقديم: د. محمد يونس و د. حسام الحجار.',
  },
  {
    id: 'vibe-coding',
    title: 'Vibe Coding',
