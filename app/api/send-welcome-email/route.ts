...
const TEMP_TOKEN = 'welcome-7d2c4f1a-8b3e-4c9d-a5e6-0f1a2b3c4d5e';
...
<div style="padding:28px 24px">
  ...
  <p style="color:#4a5b78;font-size:15px;line-height:1.9;margin:0 0 20px 0;text-align:center">
    أهلاً بك في مجتمع مرفأ! يسعدنا انضمامك إلى نخبة من رواد الأعمال والمستثمرين في حائل.
    <br/>هذه أبرز ما يمكنك فعله الآن:
  </p>
  ...
  <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:24px">
    ...
    <a href="https://www.marfa.sa/meetings" style="display:block;background:#faf8f2;border:1px solid #c9a84c33;border-radius:12px;padding:14px 16px;text-decoration:none;color:#0a0f1e;text-align:right">
      ...
      <span style="font-size:12px;color:#64748b">٢٧ لقاء تدريبي — كل جمعة — مع تقييم شهري من مستشارين معتمدين</span>
    </a>
  ...
  <div style="background:#faf8f2;border:2px solid #c9a84c;border-radius:12px;padding:14px 16px;margin-bottom:24px;text-align:center">
    <span style="font-weight:bold;color:#0a0f1e;font-size:14px">📍 لقاؤنا الأسبوعي</span>
    <span style="font-size:12px;color:#64748b">— كل جمعة بعد الصلاة، فندق هوليداي فيلا حائل</span>
  </div>

  <div style="text-align:center">
    <a href="https://www.marfa.sa/meetings" style="display:inline-block;background:linear-gradient(135deg,#c9a84c,#d4a843);color:#0a0f1e;padding:14px 32px;border-radius:50px;text-decoration:none;font-weight:bold;font-size:15px">🚢 ادخل إلى مرساك</a>
  </div>
