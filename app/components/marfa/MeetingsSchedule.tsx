...
import { SCHEDULE_DATA, formatDate, getFridayDates, getThisFridayIndex } from './scheduleData';
...
export default function MeetingsSchedule() {
    const scheduleDates = useMemo(() => getFridayDates(), []);
        ...
        <div className="space-y-12">
            ...
            <Card className="overflow-hidden bg-white border border-[#c9a84c]/20 rounded-3xl shadow-[0_8px_30px_rgba(10,15,30,0.06)]">
                <div className="p-6 border-b border-[#c9a84c]/10">
                    <h3 className="text-xl font-bold text-[#0a0f1e]">جدول لقاءات مرفأ (17 لقاءً أسبوعياً)</h3>
