...
export const metadata: Metadata = {
  ...
  title: {
    default: 'مرفأ | منصة سعودية لتدريب رواد الأعمال وتطوير المشاريع',
    template: '%s | مرفأ',
  },
  description:
    'مرفأ منصة سعودية لتدريب رواد الأعمال وتطوير المشاريع الناشئة في المملكة. طوّر فكرتك بأدوات ذكاء اصطناعي وبرامج عملية بما يتوافق مع رؤية السعودية 2030. حيث ترسو الطموحات.',
  keywords: [
    'تدريب رواد الأعمال',
  ...
  openGraph: {
    ...
    siteName: 'مرفأ | Marfa',
    images: [{ url: '/opengraph-image.png', width: 1200, height: 630, alt: 'مرفأ - منصة تدريب رواد الأعمال السعودية' }],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'منصة سعودية لتدريب رواد الأعمال وتطوير المشاريع الناشئة بما يتوافق مع رؤية السعودية 2030.',
