...
export default async function ArticlePage({ params }: { params: Promise<{ category: string; slug: string }> }) {
  ...
  const htmlContent = renderMarkdown(article.content_ar);
  ...
  return (
    <main className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-[#faf8f2]" dir="rtl">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {/* Article body */}
        <div className="prose-custom bg-white rounded-2xl p-8 border border-[#c9a84c]/20 shadow-[0_8px_30px_rgba(10,15,30,0.04)]"
