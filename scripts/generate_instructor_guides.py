#!/usr/bin/env python3
"""
Generate 17 instructor guides (PDF) via Anthropic API + WeasyPrint,
...
SCHEDULE_DATA = [
    ...
    {"num": "08", "encounter": "اللقاء 8",  "topic": "تآكل الهوامش",          "case": "Nice One",                "challenge": "من هامش ربح 7.13% في «السنة الذهبية» 2024 (مبيعات تجاوزت المليار ريال) إلى خسارة صافية 19.93 مليون ريال في الربع الثاني 2026 بهامش -10.5%. كيف تتآكل الأرباح رغم ثبات المبيعات؟ وما علامات الإنذار المبكر التي كان يجب رصدها منذ الإدراج؟", "slug": "margins"},
    {"num": "09", "encounter": "اللقاء 9",  "topic": "الابتكار",              "case": "Netflix",                 "challenge": "كيف تُقدم على تدمير نموذج عملك الناجح حالياً لتبني نموذجاً جديداً، قبل أن يفعلها منافس؟",                           "slug": "innovation"},
    {"num": "10", "encounter": "اللقاء 10", "topic": "الاندماج والاستحواذ",   "case": "Elm",                     "challenge": "استحواذ عِلم على «ثقة» من صندوق الاستثمارات العامة — مساهمها الأكبر — بـ 3.4 مليار ريال (~19 ضعف الأرباح) بتمويل معظمه دين. متى يكون شراء النمو أذكى من بنائه؟ وكيف تُحمى حقوق صغار المساهمين في صفقات الأطراف ذات العلاقة؟", "slug": "mergers"},
    {"num": "11", "encounter": "اللقاء 11", "topic": "الموارد البشرية",       "case": "Google Project Aristotle","challenge": "ما الذي يصنع فريقاً عالي الأداء فعلاً؟ الأمان النفسي مقابل \"تجميع النجوم\".",                                         "slug": "hr"},
    {"num": "12", "encounter": "اللقاء 12", "topic": "اقتصاديات التأمين",     "case": "Tawuniya",                "challenge": "هامش صافٍ ~5% فقط — نفس الرقم الذي أنذر بانهيار نايس ون — لكنه هنا نموذج ممتاز: محفظة استثمارات 12.6 مليار ريال ممولة من أقساط العملاء تدر 764 مليون سنوياً. متى يكون الهامش الرفيع صحياً؟ وما ضوابط «العائم» حتى لا يتحول امتيازه إلى دين؟", "slug": "insurance"},
    {"num": "13", "encounter": "اللقاء 13", "topic": "إدارة المخاطر",          "case": "Theranos",                "challenge": "كيف يكتشف المستثمر علامات الخطر مبكراً قبل ضخ رأس المال؟ ودرس في أهمية الشفافية والحوكمة لرائد الأعمال نفسه.",       "slug": "risk"},
    {"num": "14", "encounter": "اللقاء 14", "topic": "التوسع الدولي",          "case": "IKEA",                    "challenge": "كيف توازن الشركة بين \"المعيار العالمي\" و\"التكيف المحلي\"؟ إسقاط على التوسع من حائل إلى أسواق خليجية أخرى.",        "slug": "expansion"},
    {"num": "15", "encounter": "اللقاء 15", "topic": "إدارة الأزمات",          "case": "Johnson & Johnson",       "challenge": "كيف تدار أزمة ثقة المستهلك بشفافية تحفظ سمعة العلامة التجارية بدلاً من تدميرها؟",                                   "slug": "crisis"},
    {"num": "16", "encounter": "اللقاء 16", "topic": "الاستدامة والمسؤولية",   "case": "Patagonia",               "challenge": "هل يمكن أن يتوافق الربح مع القيم؟ وكيف تُبنى نماذج أعمال مستدامة تتماشى مع رؤية 2030 دون التضحية بالجدوى المالية؟",  "slug": "sustainability"},
    {"num": "17", "encounter": "اللقاء 17", "topic": "دراسة الجدوى",           "case": "Quibi",                   "challenge": "لماذا يفشل مشروع ضخم التمويل وبفريق نجوم؟ درس في التحقق من حاجة السوق الفعلية قبل بناء المنتج.",                    "slug": "feasibility"},
]
